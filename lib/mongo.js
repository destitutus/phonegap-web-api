...
// project - String, project name
// uid - String, current user uid
exports.removeProject = function (user, project, uid) {
    return phonegapProjectsCollection().then(function (projects) {
        var remove = q.denodeify(projects.remove.bind(projects));
        return remove({user: user, project: project, uid: uid});
    });
};
...
exports.saveProject = function (user, project, uid, data) {
    return phonegapProjectsCollection().then(function (projects) {
        ...
        return update({user: user, project: project, uid: uid},
