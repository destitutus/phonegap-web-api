...
var map = {
    ...
    'init': { args: ['user', 'project'], method: 'get', fn: init},
    'info': { args: ['user', 'project', 'uid'], method: 'get', fn: build.buildInfo},
    'build': { args: [ 'user', 'project', 'uid', 'key', RAW_TOKEN ], method: 'post', fn: build.build}
};
